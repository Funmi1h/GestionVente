...
public class FormulaireConnexion extends JPanel {
    ...
    private JPanel creerPanneauDroit() {
        ...
        JPanel champTel = creerChampAvecIcone("06 12 34 56 78", "telephone", champTelephone);
        JPanel groupeTelephone = creerGroupe("Numéro de téléphone", champTel);
        ...
        panelRight.add(groupeTelephone);
